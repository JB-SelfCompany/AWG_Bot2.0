...
- 📱 **Ключ** в формате `vpn://` при получении конфигурации клиента, для использования в [AmneziaVPN](https://github.com/amnezia-vpn/amnezia-client)
...
1. **Добавление клиента:**
   ...
   - Введите имя клиента
   - Укажите endpoint (если не указан в параметрах сервера)
